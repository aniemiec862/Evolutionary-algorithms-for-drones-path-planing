...
for algorithm in df_grouped['Algorithm'].unique():
    ...
    plt.title(f'{algorithm} - Średni czas trwania ewolucji modelu 2D\n w zależności od liczby generacji', fontsize=20, pad=16)
    plt.xlabel('Liczba generacji', fontsize=18)
    plt.ylabel('Czas [s]', fontsize=18)
